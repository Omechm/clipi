                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'vtds6g9s' /* Edit customer data if necessar... */,
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FlutterFlowDropDown<String>(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'kzr0rj00' /* Birthday Month */,
                          ),
                          searchHintText: FFLocalizations.of(context).getText(
                            'r3d3z4pm' /* Search for an item... */,
                          ),
                          icon: Icon(
                        ...
                        TextFormField(
                          controller: _model.valueTextController,
                          ...
                          validator: _model.valueTextControllerValidator
                              .asValidator(context),
                        ),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: _model.neighborhoodTextController,
                          ...
                          validator: _model.neighborhoodTextControllerValidator
                              .asValidator(context),
                        ),
                        TextFormField(
