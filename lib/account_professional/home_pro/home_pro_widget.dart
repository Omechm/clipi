...
import 'home_pro_model.dart';
export 'home_pro_model.dart';

class HomeProWidget extends StatefulWidget {
  const HomeProWidget({super.key});

  static String routeName = 'HomePro';
  static String routePath = '/homePro';

  @override
  State<HomeProWidget> createState() => _HomeProWidgetState();
}

class _HomeProWidgetState extends State<HomeProWidget> {
  late HomeProModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeProModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.outputListOfTimes = await actions.generate12HourTimesFromStart(
      ...
      FFAppState().timeList12Hr =
          _model.outputListOfTimes!.toList().cast<String>();
      FFAppState().update(() {});
      _model.nowLineTopPadding = valueOrDefault<double>(
        functions.calculateNowLineTop(
            150.0,
            valueOrDefault<int>(
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'll23cbjt' /* You are in your schedule */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelSmall
                                                  ...
                                                  children: List.generate(
                                                    ...
                                                    return InkWell(
                                                      ...
                                                      child: wrapWithModel(
                                                        ...
                                                        child: DayweekWidget(
                                                          key: Key(
                                                            'Keyl59_${dayItem.dateTime!.toString()}',
                                                          ),
                                                          dayWeek: dayItem.day,
                                                          dayNumber:
                                                              dayItem.dayNumber,
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'xr2sprhb' /* Select timeline start hour */,
                                    ),
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    options: List<String>.from(['6', '7', '8']),
                                    optionLabels: [
                                      FFLocalizations.of(context).getText(
                                        '6iqbfil1' /* 6:00 AM */,
                                      ),
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      _model.outputListOfTimesCopy =
                                          await actions
                                              .generate12HourTimesFromStart(
                                        functions.getStartOfDay(
                                            getCurrentTimestamp,
                                            int.parse((_model.dropDownValue!))),
                                      );
                                      FFAppState().timeList12Hr = _model
                                          .outputListOfTimesCopy!
                                          .toList()
                                          .cast<String>();
                                      FFAppState().update(() {});
                                      _model.nowLineTopPadding =
