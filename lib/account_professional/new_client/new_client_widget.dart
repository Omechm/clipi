...
class NewClientWidget extends StatefulWidget {
  ...
  static String routeName = 'NewClient';
  static String routePath = '/newClient';
...
class _NewClientWidgetState extends State<NewClientWidget>
  ...
  void initState() {
    ...
    _model.numberPhoneMask = MaskTextInputFormatter(mask: '+# (###) ###-##-##');
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              validator: _model
                                  ...
                                  .asValidator(context),
                              inputFormatters: [_model.numberPhoneMask],
                            ),
                            FlutterFlowDropDown<String>(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'dsb1e540' /* Birthday Month */,
                              ),
                              searchHintText:
                                  FFLocalizations.of(context).getText(
                                'pc2mcwht' /* Search for an item... */,
                              ),
                              icon: Icon(
