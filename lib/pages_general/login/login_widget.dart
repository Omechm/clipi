      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(0.0, 28.0, 0.0, 20.0),
                child: ClipRRect(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'bt95p9kv' /* Don't  have an account? */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
